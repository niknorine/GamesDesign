...
namespace DeepSky.Haze
{
    ...
    public class DS_HazeZoneEditor : Editor
    {
        ...
        private const string kPresetsFolder = "Contexts";
        private const string kPresetsFolderPath = "Assets/DeepSky Haze";
        private const string kPresetsPath = kPresetsFolderPath + "/" + kPresetsFolder;
